...
import matplotlib
matplotlib.use('Agg')  # Set the backend to Agg or TkAgg
...
if __name__ == '__main__':
    ...
    wrapped_env = ObservationSpaceWrapper(wrapped_env, new_obs_space)
    ...
    # Set the style, context, and palette
    #plt.style.use("darkgrid")
    #plt.rc_context({"axes.edgecolor": "gray", "axes.facecolor": "white"})
    #palette = plt.get_cmap("rainbow")

    # Create the line plot
    plt.plot(df1["episodes"], df1["reward"])

    # Set the title
    plt.title("REINFORCE for InvertedPendulum-v4")
